...
**角标怎么用**：鼠标点鲸鱼右上角的角标，气泡会用小鲸鱼的口吻说当前出了什么事（例如「我...我的余额只剩 ¥3.20 啦...（告警线 ¥5.00）」），再点一下它小声给个建议（例如「要充一点点钱吗？或者把告警线调低一点点...」），来回切换。气泡只有正文 + 一行小字提示，没有标题行；数字（余额、告警线、今日已用、预算、版本号）都会带上。
